...
@Component({
  selector: 'app-mothertrip-edit-form',
  templateUrl: './mothertrip-edit-form.component.html',
})
export class MotherTripEditFormComponent implements OnInit {
  @Input()
  ...
  addItem() {
    ...
    (this.myFormArray as any).addItem(new MotherTripEntity());
  }
