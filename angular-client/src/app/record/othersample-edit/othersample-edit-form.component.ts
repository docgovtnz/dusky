...
@Component({
  selector: 'app-othersample-edit-form',
  templateUrl: './othersample-edit-form.component.html',
})
export class OtherSampleEditFormComponent implements OnInit {
  @Input()
  ...
  addItem() {
    ...
    const added: FormGroup = (this.myFormArray as any).addItem(
      new OtherSampleEntity()
    );
    const existing: OtherSampleEntity[] = this.myFormArray.getRawValue();
