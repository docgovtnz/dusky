...
@Component({
  selector: 'app-spermsample-edit-form',
  templateUrl: './spermsample-edit-form.component.html',
})
export class SpermSampleEditFormComponent implements OnInit {
  @Input()
  ...
  addItem() {
    ...
    const added: FormGroup = (this.myFormArray as any).addItem(
      new SpermSampleEntity()
    );
    const existing: SpermSampleEntity[] = this.myFormArray.getRawValue();
