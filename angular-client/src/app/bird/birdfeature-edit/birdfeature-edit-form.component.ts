...
@Component({
  selector: 'app-birdfeature-edit-form',
  templateUrl: './birdfeature-edit-form.component.html',
})
export class BirdFeatureEditFormComponent implements OnInit {
  @Input()
  ...
  addItem() {
    ...
    (this.myFormArray as any).addItem(new BirdFeatureEntity());
  }
