...
@Component({
  selector: 'app-microbiologyandparasitologytest-edit-form',
  templateUrl: './microbiologyandparasitologytest-edit-form.component.html',
})
export class MicrobiologyAndParasitologyTestEditFormComponent
  implements OnInit {
  @Input()
  ...
  addItem() {
    ...
    const fg = (this.myFormArray as any).addItem(
      new MicrobiologyAndParasitologyTestEntity()
    );
